...
export type MeetingFollowUpLaunchRequest =
  | { kind: 'ACTION_ITEM'; agendaItemId: number; requestId: number }
  | { kind: 'DECISION'; agendaItemId: number | null; requestId: number }
...
export type MeetingFollowUpSectionKey =
  | 'action-items'
  | 'decisions'
  | 'notes'
  | 'related-meetings'
